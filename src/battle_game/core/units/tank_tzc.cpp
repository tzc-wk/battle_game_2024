...
Tank_tzc::Tank_tzc(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void Tank_tzc::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void Tank_tzc::TankMove(float move_speed, float rotate_angular_speed) {
...
bool Tank_tzc::IsHit(glm::vec2 position) const {
...
const char *Tank_tzc::UnitName() const {
  return "Tank_tzc";
}

const char *Tank_tzc::Author() const {
  return "tzc_wk";
}
}  // namespace battle_game::unit
